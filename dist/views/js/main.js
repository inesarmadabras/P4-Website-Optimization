...
var pizzasDiv = document.getElementById("randomPizzas"); //Optimized -> definition of this variable is now out of for loop.
for (var i = 2; i < 100; i++) {
...
document.addEventListener('DOMContentLoaded', function () {  //optimized
    var cols = 8;
    var s = 256;
